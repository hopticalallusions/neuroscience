% sketches on bidirectional filtering
...
[test,head]=readFscvRaw('/Volumes/BlueMiniSeagateData/andrewhowe_blairlab/V4/3-20-2015/run/platterSync/platterseq2_100101');
[test,head]=readFscvRaw('/Volumes/BlueMiniSeagateData/andrewhowe_blairlab/da5/da1-maybe-calibration-da5/day2_newprobes/b35-ch1/ch1-b35-1_00-um-c');

fclose(fscvFid)
fscvFid=fopen('/Volumes/BlueMiniSeagateData/andrewhowe_blairlab/da5/da1-maybe-calibration-da5/day2_newprobes/b35-ch1/ch1-b35-1_00-um-c','r');
fscvFid=fopen('/Volumes/BlueMiniSeagateData/andrewhowe_blairlab/V4/3-20-2015/run/platterSync/platterseq2_100101','r');
fseek(fscvFid, 0, 1); pos=ftell(fscvFid); fseek(fscvFid, 10000, 'bof'); data = fread( fscvFid, 'int16','b' );
figure(10); imagesc(reshape(data, 1000, length(data)/1000)-median(reshape(data, 1000, length(data)/1000)'));
fscvData=reshape(data, 1000, length(data)/1000);
