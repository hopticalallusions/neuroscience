pxPerCm = 2.7;  % approximated from tip to tip measurements of arms. I plotted a frame and a whole xy location data set and chose points. sqrt( (618-180)^2 + (424-46)^2 )/218  sqrt( (648-223)^2 + (18-436)^2 )/218;  and this is from an entrance to open field to the other side sqrt( (334-493)^2 + (311-183)^2 )/76


maskDir='~/Desktop/';
mazeMask=imread( [ maskDir 'mazeLinearizedMask2.png' ] );
mazeMask=mean( mazeMask, 3 );
mazeMask = mazeMask < 200;
...
% where is the mask
%scatter(mazeMaskX,mazeMaskY,'filled'); alpha(.1);
%mazeMaskX = mazeMaskX-30;
%mazeMaskY = mazeMaskY+24;
...
%folders={'/2018-04-27_training1/'  '/2018-05-01_training3_bananas/' '/2018-05-02_training4_bananas/' '/2018-05-03_training5_bananas/' '/2018-05-07_training6_bananas/' '/2018-05-08_training7_bananas/'  '/2018-05-09_training8_bananas/' '/2018-05-10_training9_bananas_raw/' '/2018-05-11_training10_bananas/'  '/2018-05-14_training11_bananas/'  '/2018-05-15_training12_bananas/'  '/2018-05-16_training13_bananas/'  '/2018-05-18_training14_bananas/' '/2018-06-08_training15_bananas/'  '/2018-06-11_training16_bananas/' '/2018-06-12_training17_bananas/' '/2018-06-13_training18_bananas/'  '/2018-06-14_training19_bananas/' '/2018-06-15_training20_bananas/' };
folders={'2018-04-27'  '2018-05-01' '2018-05-02' '2018-05-03' '2018-05-07' '2018-05-08'  '2018-05-09' '2018-05-10' '2018-05-11' '2018-05-14'  '2018-05-15'  '2018-05-16'  '2018-05-18' '2018-06-08'  '2018-06-11' '2018-06-12' '2018-06-13'  '2018-06-14' '2018-06-15' };
%folderdates={'2018-04-27'  '2018-05-01' '2018-05-02' '2018-05-03' '2018-05-07' '2018-05-08'  '2018-05-09' '2018-05-10' '2018-05-11' '2018-05-14'  '2018-05-15'  '2018-05-16'  '2018-05-18' '2018-06-08'  '2018-06-11' '2018-06-12' '2018-06-13'  '2018-06-14' '2018-06-15' };

binResolution = round(7*2.9); % px/bin
xyHist=[];
...
% these are training days I'll have to handle otherwise.
folders = { '2018-07-05' '2018-07-06' };

%== Data That Needs Fixin'==
% telemetry build
%
% 2018-07-05 -- training, no behavior information
% 2018-07-06 -- training, no behavior information
%
...
% together, but it's going to be a PITA
%
% 2018-08-06 -- has bad NVT data. much too small; req. vid extraction
% 2018-08-08 -- has bad NVT data. much too small; req. vid extraction
