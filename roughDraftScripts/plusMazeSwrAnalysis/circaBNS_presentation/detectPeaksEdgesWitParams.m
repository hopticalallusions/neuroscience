function detectorOutput = detectPeaksEdgesWitParams( signalEnvelope, signalTimes, signalSampleRate, streakThreshold, extentThreshold, MinPeakDistance, peakThreshold )
