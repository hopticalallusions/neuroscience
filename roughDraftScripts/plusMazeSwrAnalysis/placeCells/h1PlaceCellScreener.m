...
dir='/Volumes/AHOWETHESIS/h1/2018-09-06_11-40-56/';
ttFilenames={ 'TT1a.NTT' 'TT3a.NTT' 'TT4a.NTT' 'TT5a.NTT' 'TT6a.NTT' 'TT8a.NTT' 'TT10a.NTT' 'TT13a.NTT' 'TT15a.NTT' 'TT17a.NTT' 'TT21a.NTT' 'TT22a.NTT' };
dateStr='2018-09-06';
startCoordinate = [198 422]; startRadius = 32;%  {130,280}  start area  {radius}
bucketCoordinate =[ 363,401 ; 405, 393 ]; bucketRadius = [ 47  47 ];
...
[xrpos,yrpos]=rotateXYPositions(xpos,ypos,370,255,48,300,300);
% not a great plan...
xrpos(xrpos<1) = 1;
yrpos(yrpos<1) = 1;
% 
...
print(gcf, [ '~/data/h1_positionPlot1_' dateStr '_.png'],'-dpng','-r200');

startCoordinate = [58 288]; startRadius = 32;%  {130,280}  start area  {radius}
bucketCoordinate =[ 186,395 ; 219, 436; 176,200; 200,162 ]; bucketRadius = [ 47  47 ];
...
% tt13, tt19 - theta   ch20  maybe others not noted.
[ lfpTheta, lfpTimestamps ]=csc2mat( [ dir 'CSC20.ncs' ] );
...
% tt10, tt22 - swr  ch84; ch20; ch32; ch64; ch17
[ lfpSwr ]=csc2mat( [ dir 'CSC84.ncs' ] );
...
print(gcf(1), [ '~/data/h1_positionPlot_' dateStr '_.png'],'-dpng','-r200');
