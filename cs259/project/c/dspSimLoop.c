...
void realtime_theta_phase_sw( int *lfp, int input_size, double *digitized)
{
	...
	*/
	...
	double arctanLookup[] = { 45.0, 26.5650511770780, 14.0362434679265, 7.12501634890180, 3.57633437499735, 1.78991060824607, 0.895173710211074, 0.447614170860553, 0.223810500368538, 0.111905677066207, 0.0559528918938037, 0.0279764526170037, 0.0139882271422650, 0.00699411367535292, 0.00349705685070401, 0.00174852842698045, 0.000874264213693780, 0.000437132106872335, 0.000218566053439348, 0.000109283026720071, 5.46415133600854e-05, 2.73207566800489e-05, 1.36603783400252e-05, 6.83018917001272e-06, 3.41509458500637e-06, 1.70754729250319e-06 };
	...
	*/
	...
	double angleCache[numberOfBandsToPass] = { };
	   ...
	   if ( 0 == dataIndex % everyNthSample ) {
			...
			for ( k=0; k<numberOfBandsToPass; k++ ) 
			{
			 ...
			 if ( tempMax < envThreshold ) 
			 {
				 ...
				 digitized[dsIdx] = angleCache[tempMaxIdx]/36; // this really depends on both the output size of the CORDIC and the desired number of levels
			 }
		}
	}
};
