...
if dispenseInitialReward
    ...
    NlxSendCommand('-PostEvent "reward dispensed left" 64 64');
    NlxSendCommand('-DigitalIOTtlPulse PCI-DIO24_0 0 6 High'); % master 8 port 2
    NlxSendCommand('-PostEvent "reward dispensed right" 65 65');
    pause(.5);
    NlxSendCommand('-DigitalIOTtlPulse PCI-DIO24_0 2 0 High'); % master 8 port 1
    NlxSendCommand('-DigitalIOTtlPulse PCI-DIO24_0 0 6 High'); % master 8 port 2
end
...
%         end
        ...
        if currentZone == 0
            ...
            if ready
                ...
                if left
                    NlxSendCommand('-DigitalIOTtlPulse PCI-DIO24_0 2 0 High'); % master 8 port 1
                    NlxSendCommand('-PostEvent "reward dispensed left" 64 64'); % Notify Neuralynx of event due to flaky hardware issuse
                    pause(.1);
                    NlxSendCommand('-DigitalIOTtlPulse PCI-DIO24_0 2 0 High'); % master 8 port 1
